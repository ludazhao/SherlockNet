...
cmd:option('-cnn_weight_decay', 0.001, 'L2 weight decay just for the CNN')
...
cmd:option('-checkpoint_path', '/data/captioning/models', 'folder to save checkpoints into (empty = this folder)')
