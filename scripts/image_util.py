...
def gen_aug_imgs(num_imgs, file_path, num_existing_augs=0, flip_left_right=False, random_crop=0, random_scale=0, random_brightness=0):
    ...
    for i in xrange(num_existing_augs, num_existing_augs + num_imgs):
        ...
        print 'margin_scale=%s' % margin_scale
        print 'resize_scale=%s' % resize_scale
